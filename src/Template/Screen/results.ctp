        ...
        <div class="carousel-item active view hm-black-strong" style="background-image: url('/img/arena.jpg'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="full-bg-img flex-center white-text">
                <ul class="animated fadeInUp col-md-12">
                    <li>
                        <h1 class="h1-responsive flex-item"><strong><?php echo $countrydetails['name']?>: <?php echo $average?></strong></h1>
                    </li>
...
<!--/.Carousel Wrapper-->
<div class="footer">
  <h1 class="scores">Staging: <strong><?php echo $scores['ave_staging']; ?></strong> &nbsp;&nbsp;&nbsp;&nbsp; Song: <strong><?php echo $scores['ave_song']; ?></strong> &nbsp;&nbsp;&nbsp;&nbsp; Would you?: <strong><?php echo $scores['ave_singer'];?></strong> &nbsp;&nbsp;&nbsp;&nbsp; Performance: <strong><?php echo $scores['ave_overall']; ?></strong></h1>
</div>
<script>
(function($) {
