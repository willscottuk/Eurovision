    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $ranking->country_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $ranking->country_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $ranking->country_id], ['confirm' => __('Are you sure you want to delete # {0}?', $ranking->country_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
