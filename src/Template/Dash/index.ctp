    ...
    <div id="carousel-example-3" class="carousel slide carousel-fade white-text" data-ride="carousel" data-interval="8000">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <!-- Second slide -->
            <div class="carousel-item view hm-black-strong" style="background-image: url('https://mdbootstrap.com/img/Photos/Horizontal/Nature/full%20page/img%20(22).jpg'); background-repeat: no-repeat; background-size: cover;">
